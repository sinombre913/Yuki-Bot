...
export async function before(m, {conn, participants}) {
  ...
  if (chat.eventos && m.messageStubType == 29) {
...
thumbnailUrl: catalogo 
  ...
  if (chat.eventos && m.messageStubType == 27) {
...
thumbnailUrl: catalogo 
  ...
  if (chat.eventos && m.messageStubType == 28) {
...
thumbnailUrl: catalogo 
  ...
  if (chat.eventos && m.messageStubType == 32) {
    let ax;
...
thumbnailUrl: catalogo 
  ...
  if (chat.eventos && m.messageStubType == 26) {
    let accion;
...
thumbnailUrl: catalogo 
  ...
  if (chat.eventos && m.messageStubType == 21) {
